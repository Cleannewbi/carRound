...
public interface iMyPageDao {
	...
	public List<MemberDto> getMyPageList(String id); //회원 정보 출력(not list, 1인 개인)
	
	public List<RentDto> getRentPageList(String id); //회원이 사용중인 서비스(car list-it shows 빌린날짜,반납날짜 등)
	
	public boolean updateMyPage(MemberDto dto); //회원 정보 수정
	...
	public boolean changeDates(int seq); //예약 날짜 변경
